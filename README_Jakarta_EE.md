...
```
docker run -it --rm -p 8080:8080 master-library:v1
```

Once the runtime starts, you can access the project at [http://localhost:8080/master-library](http://localhost:8080/master-library).
