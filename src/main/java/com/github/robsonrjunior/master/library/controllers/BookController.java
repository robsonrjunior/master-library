...
public class BookController implements Serializable {
    ...
    public String save() {
        boolean creating = book.getId() == null;
        if (creating) {
        ...
        context.addMessage(
            ...
            new FacesMessage(
                ...
                creating ? "Livro criado" : "Livro atualizado",
    ...
    private void redirectToListWithError() {
        ...
        context.addMessage(
            null,
            new FacesMessage(FacesMessage.SEVERITY_ERROR, "Livro não encontrado", "O livro solicitado não existe.")
        );
        try {
            context
                .getExternalContext()
                .redirect(context.getExternalContext().getRequestContextPath() + "/book-list.xhtml");
        } catch (IOException e) {
